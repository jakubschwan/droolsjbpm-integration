...
public class ClusterManagementIntegrationTest extends ClusterManagementBaseTest {
    ...
    @Test
    public void testStartRemoveServerInstaceStopContainer() throws Exception {
        //deploy container
    ...
    @Test
    public void testStartAddServerInstanceStopContainer() throws Exception {
    ...
    @Test
    public void testStartContainerAndRemoveAllServerInstace() throws Exception {
        //deploy container
        ContainerSpec containerToDeploy = createDefaultContainer(templateOne);
        mgmtControllerClient.saveContainerSpec(templateOne.getId(), containerToDeploy);
        //get container
    ...
    @Test
    public void testRemoveAndAddNewInstanceWithContainer() throws Exception {
        turnOffBravoServer();
